...
/**
 * This is the actual Autonomous OpMode for the RED alliance for the DECODE season. It extends the
...
public class RedAuto extends BaseAutonomous {
    ...
    /**
     * Constructor for the Red Autonomous. It calls the constructor of the parent class
